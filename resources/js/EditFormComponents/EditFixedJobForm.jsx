...
//     const calculateIncomeFromPercentage = (salary, percent) => {
//         if (salary && percent) {
//             return (parseFloat(salary) * parseFloat(percent) / 100).toFixed(2);
//         }
//         return '';
//     };
...
//             // If income_type changed to percentage, calculate income
//             if (name === 'income_type') {
//                 if (value === 'Percentage') {
//                     // Calculate income based on salary and percentage
//                     const calculatedIncome = calculateIncomeFromPercentage(
//                         updatedFormData.salary,
//                         updatedFormData.percent
//                     );
//                     return {
//                         ...updatedFormData,
...
//                     };
//                 }
//                 // If changed to Manual, keep existing income value
//             }

//             // If salary or percent changes and income_type is Percentage, recalculate income
//             if ((name === 'salary' || name === 'percent') && 
//                 updatedFormData.income_type === 'Percentage') {
//                 const calculatedIncome = calculateIncomeFromPercentage(
//                     name === 'salary' ? value : updatedFormData.salary,
//                     name === 'percent' ? value : updatedFormData.percent
//                 );
//                 return {
//                     ...updatedFormData,
//                     income: calculatedIncome
...
//         // Basic validation
//         if (!formData.name.trim() || !formData.customer_number.trim() || 
...
//             // The parent will close the form and reload the table
//         } catch (error) {
...
//     const isPercentageType = formData.income_type === 'percentage';
//     const isManualType = formData.income_type === 'manual';
