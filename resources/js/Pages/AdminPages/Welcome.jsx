                ...
                <div className="grid md:grid-cols-2 items-center min-h-screen md:py-24 py-10">
                    ...
                    <div className="order-2 md:order-1 mt-6">
                        ...
                        <p className="text-white mt-6 mb-8 text-lg leading-relaxed">
                            Fast Job Solution is a premier job recruitment
                            agency dedicated to bridging the gap between
                            employers and job seekers. We specialize in
                            connecting businesses with top talent and helping
                            individuals find the perfect job opportunities
                            tailored to their skills and aspirations.
                        </p>
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            {user ? (
                                <a
                                    href="/dashboard"
                                    className="px-8 py-2 bg-white text-[#283618] font-semibold rounded-md hover:bg-gray-100 transition"
                                >
                                    Dashboard
                                </a>
                            ) : (
