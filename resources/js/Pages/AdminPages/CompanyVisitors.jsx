...
//                         <button
//                             onClick={() => handleViewConfirmedDetails(row.original)}
...
//                     <h2 className="text-xl font-bold text-gray-800">Other Visitors ({otherVisitors.length})</h2>
//                     <div className="text-sm text-gray-500">
//                         Visitors with Pending, Training, or Rejected status
//                     </div>
//                 </div> */}
//                 <MyTable 
//                     columns={columns} 
