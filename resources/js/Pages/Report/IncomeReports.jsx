...
//     // Fetch only paid visitors
//     useEffect(() => {
//         const fetchPaidVisitors = async () => {
//             try {
//                 setLoading(true);
//                 const response = await axios.get(route("ourvisitors.paid"));
//                 setPaidVisitors(response.data);
//                 setFilteredVisitors(response.data);
//             } catch (error) {
//                 console.error("Error fetching paid visitors", error);
//             } finally {
//                 setLoading(false);
//             }
//         };
...
//             setFilteredVisitors(paidVisitors);
//             setIsFiltered(false);
//             return;
//         }

//         const filtered = paidVisitors.filter((visitor) => {
...
//                                         className="w-full sm:w-40 pl-9 pr-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
...
//                             tableClassName="border-2 border-blue-200 rounded-lg overflow-hidden"
//                         />
//                     </div>
//                 )}
...
//                             No paid visitors found for the selected date range
//                         </p>
//                         <button
//                             onClick={handleClearFilters}
...
//                 {!loading && !isFiltered && paidVisitors.length === 0 && (
//                     <div className="text-center py-16 bg-white rounded-xl border border-gray-200">
//                         <p className="text-gray-400 text-lg">
//                             No paid visitors found
//                         </p>
//                         <p className="text-gray-500 mt-2">
//                             Visitors with "Paid" payment status will appear here
//                         </p>
//                     </div>
//                 )}
//             </div>
...
const IncomeReports = () => {
    ...
    useEffect(() => {
        const fetchPaidVisitors = async () => {
            try {
                ...
                // Calculate income statistics (only from income field, not salary) - SAME LOGIC
                ...
                // Calculate monthly income (current month) - only from income field - SAME LOGIC
                ...
                // Calculate yearly income (current year) - only from income field - SAME LOGIC
    ...
    // Calculate filtered total income - SAME LOGIC
    ...
    // Calculate filtered monthly income based on date filter - SAME LOGIC
    ...
    // Calculate filtered yearly income based on date filter - SAME LOGIC
